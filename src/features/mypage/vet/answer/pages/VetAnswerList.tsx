import { Badge, Button, Card, List, Space, Tag, Typography, Image } from 'antd';
import { MainContentHeader } from 'common';
import { data } from 'features/consult/reception/pages/Data';
import { AnswerModal } from 'features/mypage/user/question';
...
const VetAnswerList = () => {
    ...
    return (
        <>
            <MainContentHeader title={`MY 답변 내역`} content={content} />
            <div style={{ display: "flex", justifyContent: 'start', marginBottom: '1rem' }}>
                <Card style={{ width: '24%', marginRight: '1%', borderTop: 'solid 2px #747474' }}>
                    <h2>답변 완료</h2>
                    <h3>2건</h3>
                </Card>
                <Card style={{ width: '24%', marginRight: '1%', borderTop: 'solid 2px #747474' }}>
            ...
            <Title level={3} style={{ display: 'inline-block' }}>나의 답변 목록</Title>
