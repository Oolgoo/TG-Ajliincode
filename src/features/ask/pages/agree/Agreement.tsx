...
import { askStepAtom } from '../../recoils/askRecoil';
...
const Agreement = () => {
    ...
    const receptionStep = useSetRecoilState(askStepAtom);
            ...
            >
                ...
                >
                    ...
                    <Typography>
                        <Paragraph style={{ marginLeft: 10 }}>
                            <Text type="secondary">
                                ANIWIDE의 답변은 최대 12시간이 소요될 수 있습니다.<br/>
                                위급한 상황이 발생할 경우 즉시 병원을 방문하시기 바랍니다.
                            </Text>
                        </Paragraph>
                    </Typography>
                </div>
